...
from auth_module.utils.database import this_user_exists, register_user, get_user_by_email, delete_user
...
async def create_user(user: UserCreate):
    ...
    """
    check = this_user_exists(user.email)
...
async def inativar_usuario(user_id: str, dependencies=Depends(require_role(["admin"]))):
    sucesso = delete_user(user_id)
